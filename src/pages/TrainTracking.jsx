...
const TrainTracking = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200 via-indigo-100 to-purple-200">
      ...
      >
        <h2 className="text-2xl font-bold text-indigo-600 mb-4 text-center">Train Live Tracking</h2>
        <p className="text-gray-600 text-center">
          Train <span className="font-semibold">12345</span> is running on time. Current location:{' '}
          <span className="font-semibold">Tiruchirappalli</span>.
        </p>
      </motion.div>
    </div>
  );
